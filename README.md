...
**AI / ML:** LLM evaluation & training, machine learning, scikit-learn, Whisper, SpeechBrain, speaker analysis, transcription, summarization

**Software:** Ruby on Rails, Ruby, Python, JavaScript, APIs

**Data:** MySQL, PostgreSQL

**Infrastructure:** Linux, Docker, nginx, Passenger, CI/CD, AWS, IONOS Cloud

## Leadership

**CEO / President — JITT Holdings, Inc.**  
Technology consulting, custom software, cloud infrastructure, digital products, and business technology services.
